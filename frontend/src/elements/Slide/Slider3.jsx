...
import place7 from "../../assets/p7.png";
import place8 from "../../assets/p8.png";
import place9 from "../../assets/p9.png";
          ...
          <Container>
            <div className={styles.slide_layout}>
              <SliderContainer ref={slideRef}>
                <Slide img={place7} className={styles.img1} />
                <Slide img={place8} className={styles.img2} />
                <Slide img={place9} className={styles.img2} />
              </SliderContainer>{" "}
            </div>
